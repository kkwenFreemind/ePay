...
<%
    ...
    String receiptTitle = "ATPG";
    String vatNo = "28020674";
    String receiptAddress = "1234567890";
    String contactName = "Amy";
    String contactPhone = "02-55567777";
    String contactCellPhone = phone; //"0921009024";
    String contactEmail = "amy56@everyone.com.tw";
    String returnUrl = "http://10.31.80.100:8080/cpCreditTest/cpCreditCardResp.jsp";

    java.util.Calendar nowDateTime = java.util.Calendar.getInstance();
    String tradeDate = sdf8.format(nowDateTime.getTime());

    String libm = "K" + tradeDate;
...
<html>
    ...
    <body>
        <form action="http://10.31.80.100:8080/CPECF/deposit/OnlineDeposit.zul" method="POST"> <!-- target="_blank"> -->
