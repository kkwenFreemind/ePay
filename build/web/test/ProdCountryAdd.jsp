...
<%
    ...
    String deskey = "pgjEfWD3pLKZZBMgp37cTAVH";
    String identifyCode = "8v2r9Vb2";
   ...
   // String tmprequestBody = "MDN1=" + MDN1 + "&MDN2=" + MDN2 + "&CPLIBM=" + CPLIBM + "&SALESID=" + SALESID + "&STOREID=" + STOREID + "&STORENAME=" + STORENAME + "&APISRCID=" + APISRCID;
    ...
    String XML_DOWNSTREM_URL = "http://epay.aptg.com.tw/EPAY/dtone/OnlineCountryCodeLogin.zhtml?CPID=" + CPID;
