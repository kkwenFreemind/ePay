...
<%
    ...
    //String returnUrl = "http://10.31.80.210:8080/cpCreditTest/cpCreditCardResp.jsp";
    String returnUrl = "http://localhost:8080/cpCreditTest/cpCreditCardResp.jsp";

    java.util.Calendar nowDateTime = java.util.Calendar.getInstance();
    String tradeDate = sdf8.format(nowDateTime.getTime());

    String libm = "VAS" + tradeDate;
