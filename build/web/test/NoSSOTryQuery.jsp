...
<%
   ...
   // String tmprequestBody = "MDN1=" + MDN1 + "&MDN2=" + MDN2 + "&CPLIBM=" + CPLIBM + "&SALESID=" + SALESID + "&STOREID=" + STOREID + "&STORENAME=" + STORENAME + "&APISRCID=" + APISRCID;
    ...
    String tmprequestBody = "<ServiceTransQuery><MDN>"+MDN+"</MDN>"
            ...
            + "<STORENAME>"+STORENAME+"</STORENAME></ServiceTransQuery>";

    String requestBody = util.encrypt(deskey, tmprequestBody);

    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/nosso/OnlineNoSSO_TransQuery.zhtml?CPID=" + CPID;
