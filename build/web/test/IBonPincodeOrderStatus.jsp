...
<%
    ...
    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/IBonPincodeOrderStatus?CPID="+CPID;
    System.out.println("@@@@: XML_DOWNSTREM_URL = " + XML_DOWNSTREM_URL);
     
     
    String tmprequestBody = "<PincodeOrderStatusRequest><MDN>"+MDN+"</MDN><CPLIBM>"+CPLIBM+"</CPLIBM></PincodeOrderStatusRequest>";
