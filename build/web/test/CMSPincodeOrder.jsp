...
<%
    ...
    String SRC_ID = request.getParameter("SRC_ID");
    String STORE_ID = request.getParameter("STORE_ID");
    String SALES_ID = request.getParameter("SALES_ID");
    String TIMESTAMP = request.getParameter("TIMESTAMP");
    String OCCHECKPOING = request.getParameter("OCCHECKPOING");
    ...
    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/CMS/CMS_OnlinePinCodeDeposit.zhtml?CPID="+CPID;
