...
<html>
    ...
    <body>
        <form action="http://localhost:8080/CPECF/api/payment/A015" method="POST">
            <input type="hidden" id="data" name="encryptResponseMsg" value="<%= (new SecuredMsg(deskey,identifyCode)).encode(originalParm.toString())%>" /><br/>
        </form>
