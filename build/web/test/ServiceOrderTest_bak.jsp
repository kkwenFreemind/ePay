...
<%
    ...
    String encode_tokenid = (new SecuredMsg(deskey, identifyCode)).encode(TOKENID).toString();
    ...
    String requestBody = "<ServiceOrderRequest><CPID>" + CPID + "</CPID><MDN>"
            + encode_mdn + "</MDN><ORDER><SERVICEID>"+encode_serviceid+"</SERVICEID><SERVICENAME>"+encode_servicename+"</SERVICENAME><TOKENID>"+encode_tokenid+"</TOKENID><PRICE>"+encode_price+"</PRICE></ORDER></ServiceOrderRequest>";
