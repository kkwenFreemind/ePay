...
<%
    ...
    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/ServiceLookup";
    System.out.println("@@@@: XML_DOWNSTREM_URL = " + XML_DOWNSTREM_URL);
    Utilities util  = new Utilities();
    String encode_mdn = util.encrypt(deskey, msisdn);
    String requestBody = "<ServiceLookupRequest><CPID>" + channelID + "</CPID><MDN>"
            + encode_mdn + "</MDN></ServiceLookupRequest>";
