...
<%
    ...
    /**
     * String deskey = "ABCDFEGHIJ12345678901234"; String identifyCode =
     * "Ib67iuon";
    *
     */
    String poskey = "ABCDFEGHIJ12345678901234";
    String deskey = "Ad68w577";
    String identifyCode = "Af67iuWa";
    String md5Param = "&identifyCode=";
    String desParam = "&callerInMac="; //to PaymentGateway use callerInMac, Receive from PaymentGateway use returnOutMac   
    ...
    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/IBonPincodeOrder?CPID=" + CPID;
    System.out.println("@@@@: XML_DOWNSTREM_URL = " + XML_DOWNSTREM_URL);

    String tmprequestBody = "<PincodeOrderRequest><MDN>" + MDN + "</MDN>"
    ...
    String kkbody = new SecuredMsg(deskey, identifyCode).encode(tmprequestBody);
	...
	out.println("@@@@: requestBody = <textarea rows=10 cols=150>" + kkbody + "</textarea>");
	out.println("<br/>");
        String decode_resp = util.decrypt(poskey,responseBody);
...
%><%!class SecuredMsg {
        ...
        private String identifyCode = "BBB";
