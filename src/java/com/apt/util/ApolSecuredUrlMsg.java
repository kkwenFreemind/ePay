...
public class ApolSecuredUrlMsg {
    ...
    public ApolSecuredUrlMsg(String key, String identifyCode) {
        this.key = new SecretKeySpec(key.getBytes(), "DES");
        this.identifyCode = identifyCode;
    }

    public ApolSecuredUrlMsg(String key, String identifyCode, String characterSet) {
        this.key = new SecretKeySpec(key.getBytes(), "DES");
        this.identifyCode = identifyCode;
    ...
    public String encode(String plainText, String md5Param, String desParam) throws Exception {
        ...
        log.debug("encode plainText=" + plainText);
...
//        logger.debug("encode outMsg=" + outMsg);
        return outMsg;
    }
