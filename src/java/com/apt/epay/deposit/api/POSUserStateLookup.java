 ...
 * @author kevinchang
 */
public class POSUserStateLookup extends HttpServlet {
    //沒有LOG
    private final Logger log;

    public POSUserStateLookup() {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cpkeyflag) {
                ...
                log.info("POSUserStateLookup INPUT==>" + str_input);

                try {
                    String mdn = mdntool.getMDNByparseXMLString(str_input, "UserStateLookupRequest");
                    log.info("MDN===>" + mdn);
                    if (!"".equals(mdn)) {
        ...
        try {
            ...
            if (cpkeyflag) {
                ...
                log.info("POSUserStateLookup ResponseStr ===>\n" + responseStr);
                log.info("POSUserStateLookup encode_responseStr==>" + encode_responseStr);
