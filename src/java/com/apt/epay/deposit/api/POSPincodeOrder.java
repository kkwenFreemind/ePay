 ...
 * @author kevinchang
 */
public class POSPincodeOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cpkeyflag) {
                ...
                aPincodeOrderReqBean = mdntool.PincodeOrderServParseXMLString(str_input, "PincodeOrderRequest");
                            ...
                            if (insertresult) {
                                ...
                                if (epay_promotioncode.getPlatformtype() == 1) { //ALU
                                    ...
                                    if (result != null) {
                                        ...
                                        log.info("MDN:" + mdn + " Promotion Type(3)==>" + promotioncode + " ==>" + pomotion_type);

                                        NokiaMainPincodeUtil mainutil = new NokiaMainPincodeUtil();
                                        NokiaPincodeResultBean nokia_result = mainutil.AddMainPincode(pomotion_type, libm, mdn, pincode, tradeDate_Pincode);
