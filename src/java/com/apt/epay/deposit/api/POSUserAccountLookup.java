 ...
 * @author kevinchang
 */
public class POSUserAccountLookup extends HttpServlet {
    //沒有LOG
    private final Logger log;

    public POSUserAccountLookup() {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        log.info("PosUserAccountLookup.processRequest");
        ...
        try {
            ...
            if (cpkeyflag) {
                ...
                log.info("POSUserAccountLookup INPUT==>" + str_input);
