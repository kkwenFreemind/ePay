 ...
 * @author kevinchang
 */
public class cdr_query_month_Window extends Window {
    ...
    public void query_imsi() throws Exception {
        ...
        URL url = new URL("https://sim.npnchina.com/api/v1/imsi_query_cdr_stat");
        ...
        log.info("=============>" + imsi.toString().getBytes("UTF-8"));
