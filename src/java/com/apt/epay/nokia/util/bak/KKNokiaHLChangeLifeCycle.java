 ...
 * @author kevinchang
 */
public class KKNokiaHLChangeLifeCycle {
...
//        System.out.println(" ** sendHttpPostMsg step 01");
    ...
    public static StringBuffer retnBucketActiveXML(String system_id, String system_pwd, String libm, String mdn, String tradedate,String LC) {
...
//        String sendURL = "http://localhost:1234/gateway_servlet/gateway";
        ...
        StringBuffer bucketXml = retnBucketActiveXML(ocs_systemid, ocs_system_pwd, libm, mdn, tradedate,LC);
