...
<%
    ...
    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/DealerUserAccountLookup?CPID=" + CPID;
    System.out.println("@@@@: XML_DOWNSTREM_URL = " + XML_DOWNSTREM_URL);

    String tmprequestBody = "<UserAccountLookupRequest>"
            + "<MDN>" + MDN + "</MDN>"
            + "<STOREID>" + STOREID + "</STOREID>"
            + "<STORENAME>" + STORENAME + "</STORENAME>"
            + "</UserAccountLookupRequest>";
