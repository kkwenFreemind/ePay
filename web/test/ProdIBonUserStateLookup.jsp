...
<%
    ...
    String XML_DOWNSTREM_URL = "http://epay.aptg.com.tw/EPAY/IBonUserStateLookup?CPID=" + CPID;
    System.out.println("@@@@: XML_DOWNSTREM_URL = " + XML_DOWNSTREM_URL);

    String tmprequestBody = "<UserStateLookupRequest><MDN>" + MDN + "</MDN></UserStateLookupRequest>";
