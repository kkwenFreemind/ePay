...
<%
    ...
    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/ServiceUnReserve";
    ...
    String requestBody = "<ServiceUnReserveRequest><CPID>" + CPID + "</CPID><MDN>"
            + encode_mdn + "</MDN><TOKENID>"+encode_tokenid+"</TOKENID></ServiceUnReserveRequest>";

    //RequestEntity body;
    //body = new StringRequestEntity(requestBody, "text/xml", "utf-8");
    //System.out.println("@@@@: requestBody = " + requestBody);
    //System.out.println("@@@@:" + (new SecuredMsg(deskey, identifyCode)).sendHttpPostMsg(body, XML_DOWNSTREM_URL));
