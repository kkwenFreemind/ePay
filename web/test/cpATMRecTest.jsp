...
<%
    ...
    String deskey = "fd68w577";
    String identifyCode = "Gf67iuWa";
    ...
    originalParm.append("libm=").append(libm).append("&")
            .append("payStatus=").append(status).append("&")
            .append("payMethod=").append('2').append("&")
            .append("errDesc=").append(errDesc).append("&")
            .append("payAmount=").append(orderTotal).append("&")
            ...
            .append("payTime=").append(authDate).append("&")
...
<html>
    ...
    <body>
        <form action="http://10.31.80.210:8080/EPAY/api/ATMReq" method="POST">
...
<%!class SecuredMsg
{
    ...
    private String identifyCode = "Gf67iuWa";
