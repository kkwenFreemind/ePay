...
<%
    ...
    String StartSerialNo = request.getParameter("StartSerialNo");
    String EndSerialNo = request.getParameter("EndSerialNo");
    ...
    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/DealerVoucherChangeStatus?CPID="+CPID;
    System.out.println("@@@@: XML_DOWNSTREM_URL = " + XML_DOWNSTREM_URL);
 
    String tmprequestBody = "<VoucherChangeStatusRequest>"
            + "<STARTSERIALNO>"+StartSerialNo+"</STARTSERIALNO>"
            + "<ENDSERIALNO>"+EndSerialNo+"</ENDSERIALNO>"            
            + "<STOREID>"+STOREID+"</STOREID>"        
            + "<STORENAME>"+STORENAME+"</STORENAME>"                 
            + "</VoucherChangeStatusRequest>";
