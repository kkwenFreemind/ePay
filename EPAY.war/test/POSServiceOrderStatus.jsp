...
<%
    ...
    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/POSServiceOrderStatus?CPID="+CPID;
    System.out.println("@@@@: XML_DOWNSTREM_URL = " + XML_DOWNSTREM_URL);
 
    String tmprequestBody = "<ServiceOrderStatusRequest><MDN>"+MDN+"</MDN><CPLIBM>"+CPLIBM+"</CPLIBM></ServiceOrderStatusRequest>";
