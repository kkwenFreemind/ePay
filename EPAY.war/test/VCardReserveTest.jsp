...
<%
    ...
    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/ServiceReserve";
    ...
    String encode_uuid = util.encrypt(deskey, UUID);
    String encode_price=  util.encrypt(deskey, PRICE);
    String requestBody = "<ServiceReserveRequest><CPID>" + CPID + "</CPID><MDN>"
            + encode_mdn + "</MDN><SERVICEID>"+encode_serviceid+"</SERVICEID><UUID>"+encode_uuid+"</UUID><PRICE>"+encode_price+"</PRICE></ServiceReserveRequest>";
