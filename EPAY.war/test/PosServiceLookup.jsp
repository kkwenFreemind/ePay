...
<%
    ...
    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/POSServiceLookup?CPID="+CPID;
    System.out.println("@@@@: XML_DOWNSTREM_URL = " + XML_DOWNSTREM_URL);
 
    String tmprequestBody = "<ServiceLookupRequest><MDN>"+MDN+"</MDN></ServiceLookupRequest>";
