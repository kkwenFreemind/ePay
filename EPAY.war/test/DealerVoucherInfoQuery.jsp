...
<%
    ...
    String VoucherCard = request.getParameter("VoucherCard");
    ...
    String XML_DOWNSTREM_URL = "http://epaytde.aptg.com.tw/EPAY/DealerVoucherInfoQuery?CPID="+CPID;
    System.out.println("@@@@: XML_DOWNSTREM_URL = " + XML_DOWNSTREM_URL);
 
    String tmprequestBody = "<VoucherInfoRequest>"
